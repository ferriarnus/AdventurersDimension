...
public class PacketSyncDimensionListChanges {
     ...
     *
     * @apiNote Internal; this is invoked by {@link DimensionHelper}
    ...
    public static void updateClientDimensionLists(Set<ResourceKey<Level>> newDimensions, Set<ResourceKey<Level>> removedDimensions) {
        AdventureNetwork.INSTANCE.send(PacketDistributor.ALL.noArg(), new PacketSyncDimensionListChanges(newDimensions,removedDimensions));
    }
}
